...
public class TransactionServiceImpl implements TransactionService {
	...
	@Override
	public List<Bank> getAllBanks() throws JsonProcessingException {
...
public void deleteTxn(long txn_Id) throws JsonProcessingException {
    ...
    public TransactionSummary getTxnSummaryWithFilterBased() {
        try {
            ...
            double totalSpent = transactions.stream().mapToDouble(Transaction::getAmount)
                    .sum();
            logger.info("11111 TransactionServiceImpl-getTransactionSummary()-totalSpent{}", totalSpent);
            ...
            logger.info("2222 TransactionServiceImpl-getTransactionSummary()-expenseCategory{}", expenseCategory);
            ...
            logger.info("3333 TransactionServiceImpl-getTransactionSummary()-highestTxnBankData{}", highestTxnBankData);
            ...
            logger.info("4444 TransactionServiceImpl-getTransactionSummary()-filterTransactionsByCard{}", filterTransactionsByCard);

            Optional<Map.Entry<String, Double>> highestTxnCardDetails = filterTransactionsByCard.entrySet()
                    .stream()
                    .max(Comparator.comparingDouble(Map.Entry::getValue));
            logger.info("5555 TransactionServiceImpl-getTransactionSummary()-highestTxnCardDetails{}", highestTxnCardDetails);
            ...
            logger.info("6666 TransactionServiceImpl-getTransactionSummary()-filterTransactionsByExpense{}", filterTransactionsByExpense);

            Optional<Map.Entry<String, Double>> highestExpanseCategory = filterTransactionsByExpense.entrySet()
                    .stream()
                    .max(Comparator.comparingDouble(Map.Entry::getValue));
            logger.info("7777 TransactionServiceImpl-getTransactionSummary()-highestExpanseCategory{}", highestExpanseCategory);
            ...
            logger.info("8888 TransactionServiceImpl-getTransactionSummary()-txnDataBasedOnStatuses{}", txnDataBasedOnStatuses);
            transactionSummary.setTxnsBasedOnStatuses(txnDataBasedOnStatuses);
            logger.info("9999 TransactionServiceImpl-getTransactionSummary()-totalTransactionCount{}", transactions.size());
            transactionSummary.setTotalTransactionCount(transactions.size());
            logger.info("10 TransactionServiceImpl-getTransactionSummary()-transactionSummary {}", transactionSummary);
            logger.info("11 TransactionServiceImpl-getTransactionSummary() call ended");
            return transactionSummary;
        } catch (CustomExceptions c) {
            c.printStackTrace();
            logger.error("12 TransactionServiceImpl-getTransactionSummary() Failed {} -", c.getError());
            throw new CustomExceptions(c.getStatus(), c.getError(), "", null);
        } catch (Throwable throwable) {
            throwable.printStackTrace();
            logger.error("13 TransactionServiceImpl-getTransactionSummary() Failed {} -", throwable.getMessage());
            throw new CustomExceptions(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Exception Occurs while processing the request", throwable.getMessage(), null);
        }
    ...
    public TransactionFilterResponse getTxnSummaryWithFilterBased(String bank, String transactionFilter, LocalDate fromDate, LocalDate toDate) {
        try {
            ...
            try {
                ...
                throw new CustomExceptions(HttpStatus.NOT_FOUND.value(), "Exception Occurs while getting Transaction Data From Database", "", null);
            }
            ...
            if (CollectionUtils.isEmpty(transactionList)) {
                ...
                throw new CustomExceptions(HttpStatus.NOT_FOUND.value(), String.format("No Transaction Found in Provided Date Range %s %s", String.valueOf(fromDate), String.valueOf(toDate)), null, null);
            }
            ...
            throw new CustomExceptions(HttpStatus.NOT_FOUND.value(), "Exception Occurs while processing the request", "", null);
        }
    }
    ...
    public List<Transaction> getTransactionsByUserID(Long userId) {
        try {
            ...
            logger.info(" getTransactionsByUserID :: userTransactions ::: ", userTransactions);
	...
	@Override
	public List<Transaction> getTransactionsByackNo(Long ackNo) {
